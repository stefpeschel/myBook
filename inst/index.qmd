...
👉 [ghcr.io/stefpeschel/mybook](https://ghcr.io/stefpeschel/mybook) 🐳
...
#| eval: false
docker run -it ghcr.io/stefpeschel/mybook:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/stefpeschel/mybook:devel
```
...
#| eval: false
docker run -it ghcr.io/stefpeschel/mybook:devel bash
